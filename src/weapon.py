...
class Weapon(pygame.sprite.Sprite):
    ...
    def shoot(self, owner, angle_modif=0):
        return [Shot(owner, self.bullet_speed, self.damage, self.angle + angle_modif, self.name, oriented=True)]
...
class Remington(Weapon):
    ...
    def shoot(self, owner):
        ...
        for i in range(5):
            shots.append(Shot(owner, self.bullet_speed, self.damage, self.angle + random.uniform(-self.angle_modif, self.angle_modif), self.name, oriented=True))
        return shots
...
class KSG(Weapon):
    ...
    def shoot(self, owner):
        return [
        Shot(owner, self.bullet_speed, self.damage, self.angle, self.name, oriented=True),
        Shot(owner, self.bullet_speed, self.damage, self.angle + 0.2, self.name, oriented=True),
        Shot(owner, self.bullet_speed, self.damage, self.angle - 0.2, self.name, oriented=True)
        ]
...
class PPBizon(Weapon):
    ...
    def shoot(self, owner):
        return [
        Shot(owner, self.bullet_speed, self.damage, self.angle + random.uniform(-0.2, 0.2), self.name, oriented=True)
        ]
...
class Gun(Weapon):
    ...
    def shoot(self, owner):
        return [
        Shot(owner, self.bullet_speed, self.damage, self.angle + random.uniform(-0.1, 0.1), self.name, oriented=True)
        ]
